...
def parseText(
    ...
    # again... truetype, wtf?
    if   font is charCheck.MINI_KYLIE: y = -8
    elif font is charCheck._04B03:     y = -2
    else:                              y = 0
    ...
    if font is charCheck._04B03: return _04b03Fix(result.strip())
    return result.strip()
